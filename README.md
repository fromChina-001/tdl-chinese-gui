...
![GUI](https://img.shields.io/badge/GUI-v1.1.0-16A085)
...
3. 复制单条或多条 Telegram 消息链接；也可以直接粘贴包含链接的一整段文字。
4. 点击 **加入下载队列**，或按 **Ctrl+Enter**。
5. 程序会依次处理队列；双击队列项可打开原消息，按 **Delete** 可移除选中项。
6. 需要继续下载时直接加入下一批链接，软件不会自动退出。
